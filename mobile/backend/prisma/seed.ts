...
async function main() {
  ...
  // WORKOUT OBJECTIVES
  // ============================================================================
  console.log('📋 Seeding Workout Objectives...');
  ...
  console.log(`\n✅ Seeded ${objectives.length} workout objectives\n`);

  // ============================================================================
  // EXERCISE FAMILIES
  // ============================================================================
  console.log('👨‍👩‍👧‍👦 Seeding Exercise Families...');
  ...
  console.log(`\n✅ Seeded ${families.length} exercise families\n`);
